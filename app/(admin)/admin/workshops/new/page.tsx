...
export default async function NewWorkshopPage({
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-2xl font-semibold">Novo workshop</h1>
        <p className="text-sm text-muted-foreground">Cadastre um novo workshop.</p>
      </div>
      ...
      <form action={createWorkshop} className="grid gap-6">
        <AdminTabs
          defaultValue="info"
          tabs={[
            {
              ...
              content: (
                <section className="rounded-3xl border bg-white p-5">
                  ...
                  <div className="mt-4 grid gap-4">
                    ...
                    <ImageUrlField name="coverUrl" label="Imagem" />
