...
export default async function EditProdutoDigitalPage({
  params,
  searchParams,
}: {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-2xl font-semibold">Editar produto digital</h1>
        <p className="text-sm text-muted-foreground">Atualize os dados do produto digital.</p>
      </div>
