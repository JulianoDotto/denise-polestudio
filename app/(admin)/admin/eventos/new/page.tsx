  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Cadastre um novo evento.</p>
      </div>
                ...
                <section className="rounded-3xl border bg-white p-5">
                  ...
                  <div className="mt-4 grid gap-4">
                    ...
                    <label className="flex flex-col gap-2 text-sm">
                      ...
                      <input name="eventDate" type="date" className="w-full rounded-2xl border px-4 py-2 text-sm" />
                    </label>
