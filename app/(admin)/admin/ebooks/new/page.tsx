...
export default async function NewEbookPage({
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-2xl font-semibold">Novo ebook</h1>
        <p className="text-sm text-muted-foreground">Cadastre um novo ebook.</p>
      </div>
                  ...
                  <div className="mt-4 grid gap-4">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      ...
                      <label className="flex flex-col gap-2 text-sm">
                        ...
                        <input name="priceCents" type="number" className="w-full rounded-2xl border px-4 py-2 text-sm" />
                      </label>
                    </div>
